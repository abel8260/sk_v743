...
include('../../../login-cadastro/db/conexao.php');
 ...
 $sql90=$pdo->prepare("INSERT INTO  localidads  (   char_localidad  ,  localidad_local  ,  localidads_html  ,  localidads_src  ) VALUES( '$name_1','$local', '../cen/maps/keypoint_2040.php','../../../LAPIDE-SEMINOVA-D.png')");
 $sql90-> execute();
$keypoint = 2000;
...
<br> <a class= 'voltar' href='cen_add.html'>voltar</a> <br> <a class= 'voltar' href='./cruzamento-IV.php'>Mapa</a> <br> </div> <div class='cen_box_title' > cruzamento VI - (20,40)---</div>



<form action='keypoint_2044.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,40) - Norte---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='keypoint_2039.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,40) - Leste---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='keypoint_2036.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,40) - Sul---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
