...
<br> <a class= 'voltar' href='cen_add.html'>voltar</a> <br> <a class= 'voltar' href='tela_01_cen_map.html'>Mapa</a> <br> </div> <div class='cen_box_title' > rua eskive - (20,28)---</div>



<form action='keypoint_2021.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>rua eskive- (20,28) - Norte---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='keypoint_2028.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>rua eskive - (20,28) - Oeste---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
