...
include('../../../login-cadastro/db/conexao.php');
 $local = "ruas, coord  (20,36)  " ; 
 $name_1=$_SESSION["char"];


 $sql90=$pdo->prepare("INSERT INTO  localidads  (   char_localidad  ,  localidad_local  ,  localidads_html  ,  localidads_src  ) VALUES( '$name_1','$local', '../cen/maps/keypoint_2036.php','../../../LAPIDE-SEMINOVA-D.png')");
 $sql90-> execute();
$keypoint = 2000;
...
<br> <a class= 'voltar' href='cen_add.html'>voltar</a> <br> <a class= 'voltar' href='./cruzamento-IV.php'>Mapa</a> <br> </div> <div class='cen_box_title' > cruzamento VI - (20,36)---</div>



<form action='keypoint_2040.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,36) - Norte---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='keypoint_2035.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,36) - Leste---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='keypoint_2032.php' method='POST'><div class='cen_box' style='padding : 9px' ><br/>cruzamento VI - (20,36) - Sul---<br/>normal---<br/>ruas_de_sigdu---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
