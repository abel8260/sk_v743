...
include('../../../login-cadastro/db/conexao.php');
 $local = "andar 4 do h. golden star" ; 
...
andar 4---
<div class='cen_box' style='padding : 9px' >andar 4---<br></div>


<form action='../../../menus/static/key_14initial.php' method='POST'><div class='cen_box' style='padding : 9px' >17---<br/>ver shop inicial---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='../../../menus/cen/hotel_golden_star/andar10.php' method='POST'><div class='cen_box' style='padding : 9px' >40---<br/>ver sala 4---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='../../../menus/static/key_14initial.php' method='POST'><div class='cen_box' style='padding : 9px' >6---<br/>ver shop inicial---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='../../../menus/static/key_474.php' method='POST'><div class='cen_box' style='padding : 9px' >16---<br/>ver shop free 4---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
<form action='../../../menus/static/key_14enemy1.php' method='POST'><div class='cen_box' style='padding : 9px' >18---<br/>ver red 4---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>

<form action='../../../menus/static/key_14enemy4.php' method='POST'><div class='cen_box' style='padding : 9px' >19---<br/>ver redo 4---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
