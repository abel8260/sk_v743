...
<form action='../../../menus/cen/hotel_golden_star/andar10.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>ver sala 1---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
...
<form action='../../../menus/static/key_12initial.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>ver shop paga 1---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
<form action='../../../menus/static/key_473.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>ver shop free 1---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
<form action='../../../menus/static/key_12initial.php' method='POST'><div class='cen_box' style='padding : 9px' >---<br/>ver shop inicial---<br/>normal---<br/>hotel_golden_star---<br/><br/><button class='cen_box' type="submit">escolher</button></div></form>
