...
<br>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../static/npcs2/freyia3.png" >
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Enemy lv 2</h5>
        <p class="card-text">Por este lugar irá encontrar oponentes pra comprar como passes de luta. voce compra o monstro e usa ele pra lutar e upar. Boa diversão </p>
...
$result_usuarios= $pdo-> prepare( "SELECT * FROM shops  WHERE nome_da = 'Enemy_level_2' ORDER BY  shops . inv_id  desc LIMIT $qnt_result_pg OFFSET $inicio");
...
echo "<form action='key_12enemy1_bck.php' method='POST'>";
 ...
 echo "</div>";
    ...
    $result_pg= $pdo-> prepare( "SELECT COUNT(inv_id) AS num_result FROM shops WHERE nome_da = 'Enemy_level_1'");
    $result_pg-> execute();
...
foreach($resultado_pg as   $row_pg ) {      
    ...
    $max_links = 2;
     ...
     echo " <a href='key_12enemy1.php?pagina=1'class='page-link' aria-label='Goto page 1'>1</a>";
    for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
      if($pag_ant >= 1){

        echo "<li class='page-item'><a class='page-link' href='key_12enemy2.php?pagina=$pag_ant' > Prev:".$pag_ant."</a></li>";
      }
    }
    ...
    for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
      if($pag_dep <= $quantidade_pg){
        echo "<li class='page-item'><a class='page-link' href='key_12enemy2.php?pagina=$pag_dep'>".$pag_dep."</a> ";
      }
    }
     ...
     echo "<li class='page-item'><a class='page-link' href='key_12enemy2.php?pagina=$quantidade_pg' class='page-link' aria-label='Goto page 86'>Ultima</a></li>";
      echo "</ul>";
        echo "</nav>";
