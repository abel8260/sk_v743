...
<br>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../static/npcs2/legion14.png" >
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Fusion Boss</h5>
        <p class="card-text">Boss dificeis pra você espaçar seu tempo jogando </p>
...
$result_usuarios= $pdo-> prepare( "SELECT * FROM shops  WHERE nome_da = 'Bulls_from_north' ORDER BY inv_gold desc LIMIT $qnt_result_pg OFFSET $inicio");
...
echo "<form action='key_12enemy1_bck.php' method='POST'>";
 ...
 echo "</div>";
    ...
    $result_pg= $pdo-> prepare( "SELECT COUNT(inv_id) AS num_result FROM shops WHERE nome_da = 'Bulls_from_north'");
    $result_pg-> execute();
