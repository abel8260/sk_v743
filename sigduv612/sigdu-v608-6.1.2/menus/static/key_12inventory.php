...
<br>
  ...
  <br>
  <a class= "voltar" href="key_uso.php">usar itens </a>
<br>
<a class= "voltar" href="key_110.php">Visual</a>
<br>
</div>
...
foreach($resultado_usuarios  as  $row_usuario ) {
      ...
      echo "<div class='container'>";
       echo "<form action='key_12inventory_bck.php' method='POST'>";
          ...
          echo "<div class='content'>";
              ...
              echo "<br/>";
                ...
                echo "<div class='textbox'>";
                  ...
                  echo "<spam name='usuario' id='p01'><b>GOLD:</b> </spam><spam  id='p02'><b> ".$row_usuario['inv_gold'] . "</b></spam><br>";
                  echo "<input name='foto_enm' id='p01' type='hidden'value=".$row_usuario['inv_nome']."></input>";
                  echo "<input name='usuario' id='p01' type='hidden'value=".$row_usuario['inv_gold']."></input>";
                  echo "<input name='id' id='p01' type='hidden'value=".$row_usuario['inv_id']."></input>";
                echo "</div>";


               

              echo "<div class='venda_box'>";
                  echo "<div class='buttons'>";
                  echo "<br/>";
                  echo "<spam> Opções: </spam> ";
                  echo "<br/>";
                  echo "<input class='radio' type='radio' name='lutar' value='lutar'>minerar";
                  
              
                  echo "<input class='radio' type='radio'  name='vender' value='vender'>vender";
                  
                  echo "<input name='foto_enm' id='p01' type='hidden'value=".$row_usuario['inv_nome']."></input>";
                  echo "<input class='submit_menu' type='submit' value='enviar opção'>";
