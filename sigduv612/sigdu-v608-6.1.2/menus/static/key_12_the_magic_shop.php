...
<br>
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title"> Magick shop: </h5>
        <p class="card-text">aderir aos pergaminhos:   </p>
...
$result_usuarios= $pdo-> prepare( "SELECT * FROM shops  WHERE nome_da = 'magick' ORDER BY inv_gold desc LIMIT $qnt_result_pg OFFSET $inicio");
