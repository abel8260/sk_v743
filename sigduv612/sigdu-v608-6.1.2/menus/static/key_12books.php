...
<br>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../../static/npcs2/val4.png" >
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Books</h5>
        <p class="card-text">Magias de baixo, medio e alto nivel a escala de seres etéreos. </p>
...
$result_usuarios= $pdo-> prepare( "SELECT * FROM shops  WHERE nome_da = 'EtherDmg' ORDER BY  shops . inv_id  desc LIMIT $qnt_result_pg OFFSET $inicio");
...
foreach($resultado_pg as   $row_pg ) {      
    ...
    $max_links = 2;
     ...
     echo " <a href='key_12books.php?pagina=1'class='page-link' aria-label='Goto page 1'>1</a>";
    for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
      if($pag_ant >= 1){

        echo "<li class='page-item'><a class='page-link' href='key_12books.php?pagina=$pag_ant' > Prev:".$pag_ant."</a></li>";
      }
    }
  ...
  for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
      if($pag_dep <= $quantidade_pg){
        echo "<li class='page-item'><a class='page-link' href='key_12books.php?pagina=$pag_dep'>".$pag_dep."</a> ";
      }
    }
    ...
    echo "<li class='page-item'><a class='page-link' href='key_12books.php?pagina=$quantidade_pg' class='page-link' aria-label='Goto page 86'>Ultima</a></li>";
