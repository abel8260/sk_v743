...
<html lang="pt-br">
  <head>
   ...
   <!--básico-->  
            <meta charset="UTF-8"/>  
            <title> Clan personalização;</title>
...
<br>
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title"> Clan personalizar </h5>
        <p class="card-text"> Conjunto de brasões.</p>
...
$stmt6= $pdo-> prepare( "SELECT * FROM shops  WHERE nome_da = 'clan_pers' ORDER BY  shops . inv_id  desc LIMIT $qnt_result_pg OFFSET $inicio");
$stmt6-> execute();
