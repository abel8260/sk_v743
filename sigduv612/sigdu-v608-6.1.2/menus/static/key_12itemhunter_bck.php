...
$row_item= mysqli_fetch_assoc($resultado_usuarios);

$DONO=$name_2;
$_SESSION["gold_cust"] = $row_item['inv_gold'];
$gol=$_SESSION["gold_cust"];
$gol = - $gol;

$sql14 = "SELECT * FROM currencies WHERE Currencies_DONO ='$name_1' AND Currencies_nome = '$name_2'";
$result14 = mysqli_query($conexao,$sql14);
