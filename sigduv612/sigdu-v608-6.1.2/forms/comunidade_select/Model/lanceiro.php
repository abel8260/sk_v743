...
$sql3 = "SELECT *  FROM modelochar where status_name = 'lanceiro'";    
 $result3 = pg_query($conexao,$sql3);
$row3 = pg_fetch_assoc($result3);



$sql07889 = "SELECT * FROM fichasuno WHERE ficha_id = '$id'";
 $result07889 = pg_query($conexao,$sql07889);
$row0 = pg_fetch_assoc($result07889);
